...
typedef struct _fa_conc_idl_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } fa_conc_idl_MIDL_TYPE_FORMAT_STRING;

typedef struct _fa_conc_idl_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } fa_conc_idl_MIDL_PROC_FORMAT_STRING;

typedef struct _fa_conc_idl_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } fa_conc_idl_MIDL_EXPR_FORMAT_STRING;
...
extern const fa_conc_idl_MIDL_TYPE_FORMAT_STRING fa_conc_idl__MIDL_TypeFormatString;
extern const fa_conc_idl_MIDL_PROC_FORMAT_STRING fa_conc_idl__MIDL_ProcFormatString;
extern const fa_conc_idl_MIDL_EXPR_FORMAT_STRING fa_conc_idl__MIDL_ExprFormatString;
...
static const fa_conc_idl_MIDL_PROC_FORMAT_STRING fa_conc_idl__MIDL_ProcFormatString =
    {
        0,
        {
...
static const fa_conc_idl_MIDL_TYPE_FORMAT_STRING fa_conc_idl__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IClass1, ver. 0.0,
   GUID={0x7491B280,0x303A,0x42CF,{0xBB,0x6B,0xEA,0xD1,0x2C,0x8B,0x95,0xA7}} */
...
static const MIDL_STUBLESS_PROXY_INFO IClass1_ProxyInfo =
    {
    &Object_StubDesc,
    fa_conc_idl__MIDL_ProcFormatString.Format,
...
CINTERFACE_PROXY_VTABLE(11) _IClass1ProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IClass1::fa_conc */ ,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    fa_conc_idl__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _fa_conc_idl_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IClass1ProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _fa_conc_idl_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IClass1StubVtbl,
    0
};

PCInterfaceName const _fa_conc_idl_InterfaceNamesList[] = 
{
    "IClass1",
    0
};

const IID *  const _fa_conc_idl_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _fa_conc_idl_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _fa_conc_idl, pIID, n)

int __stdcall _fa_conc_idl_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_fa_conc_idl_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo fa_conc_idl_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _fa_conc_idl_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _fa_conc_idl_StubVtblList,
    (const PCInterfaceName * ) & _fa_conc_idl_InterfaceNamesList,
    (const IID ** ) & _fa_conc_idl_BaseIIDList,
    & _fa_conc_idl_IID_Lookup, 
    1,
    2,
