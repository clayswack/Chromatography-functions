...
{
  {
    ...
    CClass1::GetClassObject, "Class1", "fa_conc.Class1", "fa_conc.Class1.1_0"
  },
  {
    NULL, NULL, NULL, NULL, "", "", ""
  }
...
{
  initialize_path();
  return g_pModule->InitMain(objectmap, &LIBID_fa_conc, 1, 0, hInstance, dwReason, pv);
}
