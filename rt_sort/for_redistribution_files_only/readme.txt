...
-rt_sort_1_0.dll (output from mcc)
-rt_sort.bas (VBA module file created by mcc)
-rt_sort.xla (Excel AddIn file created by mcc)
-MCRInstaller.exe
...
NOTE: Verify rt_sort_1_0.dll is registered on the target machine. If you have trouble 
