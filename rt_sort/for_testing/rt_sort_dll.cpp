...
{
  {
    ...
    CClass1::GetClassObject, "Class1", "rt_sort.Class1", "rt_sort.Class1.1_0"
  },
  {
    NULL, NULL, NULL, NULL, "", "", ""
  }
...
static void initialize_path()
{
    ...
    build_mclmcrrt_name("8","3","0",mclmcrrt_name);
...
{
  initialize_path();
  return g_pModule->InitMain(objectmap, &LIBID_rt_sort, 1, 0, hInstance, dwReason, pv);
}
